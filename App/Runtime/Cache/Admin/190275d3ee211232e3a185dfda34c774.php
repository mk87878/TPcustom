...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div id="page-wrapper">
        <ul class="nav nav-tabs" id="nav_tabs">
            <li  class="active"><a href="javascript:;">栏目管理</a></li>
            <li><a href="/index.php?s=/Admin/<?php echo (CONTROLLER_NAME); ?>/intro">介绍设置</a></li>
        </ul>
        ...
        <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-9 pull-left">
                    <a href="<?php echo U('Other/add');?>" class="btn btn-primary">增加</a>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($_other)): $i = 0; $__LIST__ = $_other;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$_td): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($key+1+$_page); ?></td>

                                    <td><?php echo ($_td["title"]); ?></td>
                                    <td><?php echo ($_td["listorder"]); ?></td>
                                    <td>
                                        <a href="/index.php?s=/Admin/Other/edit&id=<?php echo ($_td["id"]); ?>">编辑</a>
...
<script>
    function search() {
        ...
        window.location.href = '/index.php?s=/Admin/<?php echo (CONTROLLER_NAME); ?>/index/search_input/' + input;
    }
</script>
