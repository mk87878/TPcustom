        ...
        <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-9 pull-left">
                    <a href="/index.php?s=/Admin/News/sort_add" class="btn btn-primary">增加</a>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($_sort)): $i = 0; $__LIST__ = $_sort;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$_td): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($key+1+$_page); ?></td>

                                    <td><?php echo ($_td["sort_name"]); ?></td>
                                    <td><?php echo (date('Y-m-d H:i',$_td["time"])); ?></td>
                                    <td>
                                        <a href="/index.php?s=/Admin/News/sort_edit&id=<?php echo ($_td["id"]); ?>">编辑</a>
...
<script>
    var SCOPE = {
        'set_status_url': '/index.php?s=/Admin/News/sort_del',
    }
</script>
<!-- JavaScript -->
...
<script>
    function search() {
        ...
        window.location.href = '/index.php?s=/Admin/News/sort_index/search_input/' + input;
    }
</script>
