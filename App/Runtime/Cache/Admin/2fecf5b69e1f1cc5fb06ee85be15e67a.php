            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($_link)): $i = 0; $__LIST__ = $_link;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$_lk): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($key+1+$_page); ?></td>
                                <td><?php echo ($_lk["name"]); ?></td>
                                <td><?php echo ($_lk["url"]); ?></td>

                                <td>
                                    <a href="/index.php?s=/Admin/Link/edit&id=<?php echo ($_lk["id"]); ?>">编辑</a>
...
<script>
    var SCOPE = {
        'set_status_url': '/index.php?s=/Admin/Link/del',
    }
</script>
<!-- JavaScript -->
