                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <select name="sort_id" class="form-control">
                            ...
                            <?php if(is_array($_sort)): $i = 0; $__LIST__ = $_sort;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$_st): $mod = ($i % 2 );++$i;?><option value="<?php echo ($_st["id"]); ?>"><?php echo ($_st["sort_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
            </div>
...
<script>
    var SCOPE = {
        'simditor_img_upload' : '/index.php?s=/Admin/Image/simditoruploadimage',
        'ajax_upload_image_url' : '/index.php?s=/Admin/Image/uploadifyimage',
